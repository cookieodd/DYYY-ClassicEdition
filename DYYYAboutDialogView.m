...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message {
    if (self = [super initWithFrame:UIScreen.mainScreen.bounds]) {
        ...
        NSRange cookieoddTGRange = [message rangeOfString:@"Telegram @cookieodd"];
        if (cookieoddTGRange.location != NSNotFound) {
            [attributedString addAttribute:NSLinkAttributeName value:@"https://t.me/COOKIEODD" range:cookieoddTGRange];
        }
        
        NSRange cookieoddGithubRange = [message rangeOfString:@"仓库地址 cookieodd/DYYY-ClassicEdition"];
        if (cookieoddGithubRange.location != NSNotFound) {
            [attributedString addAttribute:NSLinkAttributeName value:@"https://github.com/cookieodd/DYYY-ClassicEdition" range:cookieoddGithubRange];
        }
